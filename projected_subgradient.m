...
x2 = A.'*pinv(A*A.')*b;             
k = 10000;
stepsize = 100/k; % Polyak estiated step size rule
...
% title('Comparison of recovery signal and original signal using CVX','FontSize',12)
...
% title('Comparison of recovery signal and original signal using projected subgradient method','FontSize',12)
% xlabel('n','FontSize',10);
% ylabel('value of x','FontSize',10);
% axis([1 128 -0.2 1]);
% grid on
...
title('Convergence of the projected subgradient method for a L1 norm problem','FontSize',15);
